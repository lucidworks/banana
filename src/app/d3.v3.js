!function() {
  ...
  var �� = 1e-6, ��2 = �� * ��, �� = Math.PI, �� = 2 * ��, �Ӧ� = �� - ��, half�� = �� / 2, d3_radians = �� / 180, d3_degrees = 180 / ��;
  function d3_sgn(x) {
  ...
  function d3_geo_clipCircle(radius) {
    ...
    function intersect(a, b, two) {
      ...
      if (��1 < ��0) z = ��0, ��0 = ��1, ��1 = z;
      var �Ħ� = ��1 - ��0, polar = abs(�Ħ� - ��) < ��, meridian = polar || �Ħ� < ��;
      if (!polar && ��1 < ��0) z = ��0, ��0 = ��1, ��1 = z;
      if (meridian ? polar ? ��0 + ��1 > 0 ^ q[1] < (abs(q[0] - ��0) < �� ? ��0 : ��1) : ��0 <= q[1] && q[1] <= ��1 : �Ħ� > �� ^ (��0 <= q[0] && q[0] <= ��1)) {
  ...
  function d3_geo_projectionMutator(projectAt) {
    ...
    }), k = 150, x = 480, y = 250, �� = 0, �� = 0, �Ħ� = 0, �Ħ� = 0, �Ħ� = 0, ��x, ��y, preclip = d3_geo_clipAntimeridian, postclip = d3_identity, clipAngle = null, clipExtent = null, stream;
    ...
    projection.rotate = function(_) {
      if (!arguments.length) return [ �Ħ� * d3_degrees, �Ħ� * d3_degrees, �Ħ� * d3_degrees ];
      �Ħ� = _[0] % 360 * d3_radians;
      �Ħ� = _[1] % 360 * d3_radians;
      �Ħ� = _.length > 2 ? _[2] % 360 * d3_radians : 0;
      return reset();
    };
    d3.rebind(projection, projectResample, "precision");
    function reset() {
      projectRotate = d3_geo_compose(rotate = d3_geo_rotation(�Ħ�, �Ħ�, �Ħ�), project);
      var center = project(��, ��);
      ��x = x - center[0] * k;
      ��y = y + center[1] * k;
      return invalidate();
  ...
  function d3_geo_rotation(�Ħ�, �Ħ�, �Ħ�) {
    return �Ħ� ? �Ħ� || �Ħ� ? d3_geo_compose(d3_geo_rotation��(�Ħ�), d3_geo_rotation�զ�(�Ħ�, �Ħ�)) : d3_geo_rotation��(�Ħ�) : �Ħ� || �Ħ� ? d3_geo_rotation�զ�(�Ħ�, �Ħ�) : d3_geo_identityRotation;
  }
  function d3_geo_forwardRotation��(�Ħ�) {
    return function(��, ��) {
      return �� += �Ħ�, [ �� > �� ? �� - �� : �� < -�� ? �� + �� : ��, �� ];
    };
  }
  function d3_geo_rotation��(�Ħ�) {
    var rotation = d3_geo_forwardRotation��(�Ħ�);
    rotation.invert = d3_geo_forwardRotation��(-�Ħ�);
    return rotation;
  }
  function d3_geo_rotation�զ�(�Ħ�, �Ħ�) {
    var cos�Ħ� = Math.cos(�Ħ�), sin�Ħ� = Math.sin(�Ħ�), cos�Ħ� = Math.cos(�Ħ�), sin�Ħ� = Math.sin(�Ħ�);
    function rotation(��, ��) {
      var cos�� = Math.cos(��), x = Math.cos(��) * cos��, y = Math.sin(��) * cos��, z = Math.sin(��), k = z * cos�Ħ� + x * sin�Ħ�;
      return [ Math.atan2(y * cos�Ħ� - k * sin�Ħ�, x * cos�Ħ� - z * sin�Ħ�), d3_asin(k * cos�Ħ� + y * sin�Ħ�) ];
    }
    rotation.invert = function(��, ��) {
      var cos�� = Math.cos(��), x = Math.cos(��) * cos��, y = Math.sin(��) * cos��, z = Math.sin(��), k = z * cos�Ħ� - y * sin�Ħ�;
      return [ Math.atan2(y * cos�Ħ� + z * sin�Ħ�, x * cos�Ħ� + k * sin�Ħ�), d3_asin(k * cos�Ħ� - x * sin�Ħ�) ];
    };
    return rotation;
  }
  ...
  d3.svg.arc = function() {
    ...
    function arc() {
      ...
      if (da >= �Ӧ�) return circleSegment(r1, cw) + (r0 ? circleSegment(r0, 1 - cw) : "") + "Z";
