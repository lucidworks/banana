      ...
      link: function(scope, elem) {
        ...
        function render_panel() {
          ...
          if (filterSrv.idsByTypeAndField('terms',scope.panel.field).length > 0) {
            ...
            var idd = scope.$id;
            $.getJSON('http://localhost:8082/api/rca/topology', function (data) {
                            ...
                            $(go.Panel, "Table",
                                {
                                    ...
                                    itemTemplate: $("CheckBox", "checked", go.Panel.TableRow,
                                        $(go.TextBlock,  // align text towards the right, next to the Button
                                            {column: 1, alignment: go.Spot.Left},
                                            new go.Binding("text", "name")),
                                        {"Button.column": 0}  // put Button in second column, to the right of text
                                    )
                                },
