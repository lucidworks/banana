...
function (angular, app, _, $, kbn) {
  ...
  var module = angular.module('kibana.panels.d3bullet', []);
  app.useModule(module);

  module.controller('d3bullet', function($scope, $timeout, timer, querySrv, dashboard, filterSrv) {
    $scope.panelMeta = {
      exportfile: true,
      editorTabs : [
  ...
  module.directive('d3bulletChart', function(querySrv,dashboard,filterSrv) {
    return {
      restrict: 'A',
          ...
          require(['bullet'], function(){
            ...
            try {
              ...
              if(scope.panel.chart === 'd3bullet') {
                  ...
                  svg=d3.select(el).data(data1).append("svg").attr("class", "bullet").attr("width", parent_width)
