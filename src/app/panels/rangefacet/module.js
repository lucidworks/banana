...
function (angular, app, $, _, kbn, moment, timeSeries) {
  ...
  module.controller('rangefacet', function($scope, $q, querySrv, dashboard, filterSrv) {
    ...
    $scope.get_facet_range = function () {
      var range = $scope.range = filterSrv.facetRange();
      return range;
    };
    ...
    $scope.get_data = function(segment, query_id) {
      ...
      var facet = '&facet=true' +
                  ...
                  '&facet.range.end=' + $scope.panel.maximum +
    ...
    return {
      ...
      link: function(scope, elem) {
            ...
            var options = {
              ...
              series: {
                ...
                bars:   {
                  ...
                  fill: 1,
                  barWidth: barwidth/(0.1*scope.panel.minimum),
                  zero: false,
                  lineWidth: 0
                },
                points: {
              ...
              xaxis: {
                ...
                min: _.isUndefined(facet_range.minimum) ? null : scope.range.from.getTime(),
                max: _.isUndefined(facet_range.maximum) ? null : scope.range.to.getTime(),
              },
              grid: {
        ...
        elem.bind("plotselected", function (event, ranges) {
          ...
          filterSrv.set({
            type  : 'range',
            from  : parseInt(ranges.xaxis.from),
            to    : parseInt(ranges.xaxis.to),
            field : scope.panel.range_field
          });
          dashboard.refresh();
        });
