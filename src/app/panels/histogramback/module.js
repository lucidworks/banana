...
function (angular, app, $, _, kbn, moment, timeSeries) {
  ...
  var module = angular.module('kibana.panels.histogramback', []);
  app.useModule(module);

  module.controller('histogramback', function($scope, $q, querySrv, dashboard, filterSrv) {
    $scope.panelMeta = {
   ...
   module.directive('histogrambackChart', function(dashboard, filterSrv) {
    return {
      restrict: 'A',
      template: '<div></div>',
