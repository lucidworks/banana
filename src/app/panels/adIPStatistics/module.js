...
define([
    ...
    function (angular, app, _, $, kbn) {
        ...
        module.controller('adDistribution', function($scope, $timeout, $filter, timer, querySrv, dashboard, filterSrv) {
            $scope.panelMeta = {
                exportfile: true,
                editorTabs : [
            ...
            $scope.build_query = function(filetype, isForExport) {
                ...
                var facet = '';
                {
                    ...
                    facet = '&stats=true&stats.facet=facet_name_s' + '&stats.field=value_f' + '&facet.missing=true';
                }
                ...
                if(($scope.panel.linkage_id==dashboard.current.linkage_id)||dashboard.current.enable_linkage){
                    ...
                    results.then(function (results) {
...

                        {
                            ...
                            if (DEBUG) console.log(results.stats.stats_fields.value_f.facets.facet_name_s);
                            _.each(results.stats.stats_fields.value_f.facets.facet_name_s, function (stats_obj, facet_field) {
                                k = k + 1;
                        ...
                        */
                        ...
                        $scope.sort_by = function(newSortingOrder) {
                            if (DEBUG) console.log($scope.sortingOrder + "\t" + newSortingOrder);
