...
function (angular, app, _, $, kbn) {
  ...
  var module = angular.module('kibana.panels.d3Gauage', []);
  app.useModule(module);

  module.controller('d3Gauage', function($scope, $timeout, timer, querySrv, dashboard, filterSrv) {
    $scope.panelMeta = {
  ...
  module.directive('d3GauageChart', function(querySrv,dashboard,filterSrv) {
    return {
      restrict: 'A',
